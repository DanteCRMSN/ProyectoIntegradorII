...
public class MySqlActividadDAO implements ActividadDAO
{
	...
	public List<ActividadDTO> listarActividades()
	{
		...
		ResultSet rs = null;
				try {
					cn = new MySqlDBConexion().getConexion();
					String sql= "select a.cod_act, i.nom_ins,a.nom_act, a.des_act, a.fecha_act, a.horainicio_act, a.horafin_act, d.nom_doc, e.nom_estado,a.motivo_estado"+
							" from tb_actividad a inner join tb_institucion i on i.cod_ins = a.cod_ins inner join tb_estado e"+
							" on e.cod_estado = a.cod_estado inner join tb_docente d on d.cod_doc = a.cod_doc";
					pstm = cn.prepareStatement(sql);
					...
					while (rs.next()){
						...
						obj.setNom_docente(rs.getString(8));
	...
	public List<ActividadDTO> listarActividadesVolu()
	{
		...
		ResultSet rs = null;
				try {
					...
					String sql= "select a.cod_act, i.nom_ins,a.nom_act, a.des_act, a.fecha_act, a.horainicio_act, a.horafin_act, d.nom_doc, e.nom_estado,a.motivo_estado"+
							" from tb_actividad a inner join tb_institucion i on i.cod_ins = a.cod_ins inner join tb_estado e"+
							" on e.cod_estado = a.cod_estado inner join tb_docente d on d.cod_doc = a.cod_doc Where e.nom_estado = 'Aprobado'";
					pstm = cn.prepareStatement(sql);
					rs = pstm.executeQuery();
					while (rs.next()){
						obj = new ActividadDTO();
	...
	public List<ActividadDTO> buscarPorEstado(String nombreEstado) 
	{
		...
		try
		{
			...
			String sql= "select a.cod_act, i.nom_ins,a.nom_act, a.des_act, a.fecha_act, a.horainicio_act, a.horafin_act, d.nom_doc, e.nom_estado,a.motivo_estado"+
					" from tb_actividad a inner join tb_institucion i on i.cod_ins = a.cod_ins inner join tb_estado e"+
					" on e.cod_estado = a.cod_estado inner join tb_docente d on d.cod_doc = a.cod_doc Where e.nom_estado = ?";
	...
	public List<ActividadDTO> buscarPorFecha(Date fecha) 
	{
		...
		try
		{
			...
			String sql= "select a.cod_act, i.nom_ins,a.nom_act, a.des_act, a.fecha_act, a.horainicio_act, a.horafin_act, d.nom_doc, e.nom_estado,a.motivo_estado"+
					" from tb_actividad a inner join tb_institucion i on i.cod_ins = a.cod_ins inner join tb_estado e"+
					" on e.cod_estado = a.cod_estado inner join tb_docente d on d.cod_doc = a.cod_doc Where a.fecha_act = ?";
